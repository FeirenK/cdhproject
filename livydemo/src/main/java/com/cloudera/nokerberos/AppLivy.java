...
public class AppLivy {
    ...
    private static String LIVY_HOST = "http://ip-172-31-7-172.Feiren.com:8998";
...
//        HttpUtils.deleteAccess(LIVY_HOST + "/sessions/2", headers);
        ...
        //封装提交Spark作业的JSON数据
        String submitJob = "{\"className\": \"org.apache.spark.examples.SparkPi\",\"executorMemory\": \"1g\",\"args\": [200],\"file\": \"/Feiren-yarn/jars/spark-examples-1.6.0-cdh5.13.1-hadoop2.6.0-cdh5.13.1.jar\", \"proxyUser\":\"Feiren\"}";
        //向集群提交Spark作业
