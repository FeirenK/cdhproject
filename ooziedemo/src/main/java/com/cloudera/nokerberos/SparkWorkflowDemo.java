...
/**
 * package: com.cloudera.nokerberos
 * describe: 使用Oozie-client的API接口向非Kerberos集群提交Java程序
 * creat_user: Feiren
...
public class SparkWorkflowDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            properties.put("oozie.wf.application.path", "${nameNode}/user/Feirentest/oozie/testoozie");
            ...
            properties.put("jar", "${nameNode}/Feirentest/jars/spark-examples-1.6.0-cdh5.13.1-hadoop2.6.0-cdh5.13.1.jar");
            properties.put("oozie.libpath", "${nameNode}/Feirentest/jars");
            properties.put("jobTracker", "ip-172-31-6-148.Feiren.com:8032");
            properties.put("file", "${nameNode}/Feirentest/jars");
