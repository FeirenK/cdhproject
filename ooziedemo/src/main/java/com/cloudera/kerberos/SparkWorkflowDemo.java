...
//            System.out.println(oozieClient.getServerBuildVersion());
            ...
            properties.put("oozie.wf.application.path", "${nameNode}/user/Feiren/oozie/testoozie");
            ...
            properties.put("jar", "${nameNode}/Feiren/jars/spark-examples-1.6.0-cdh5.13.1-hadoop2.6.0-cdh5.13.1.jar");
